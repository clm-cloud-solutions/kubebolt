...
export function Phase2Placeholder({
  ...
  return (
    <div className="border-2 border-dashed border-kb-border rounded-lg p-8 flex flex-col items-center justify-center text-center">
      ...
      <p className="text-xs text-kb-text-tertiary mb-4 max-w-sm">{description}</p>
      <div className="bg-kb-bg rounded-md px-3 py-2 font-mono text-[10px] text-kb-text-secondary border border-kb-border">
